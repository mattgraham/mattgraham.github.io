  ...
  <ul class="list pa0 ma0 mw7 tl center">
    ...
    <li class="bb b--light-gray pv2 flex lh-copy dark-gray" id="lansing-beard">
      ...
      <div class="flex-auto">
        ...
        <div class="mv3 lh-copy dark-gray">These wrecks lie along the southeast edge of Port Huron, MI and are 'believed' to be the Lansing Shoal Lightship No. 055 and James Beard Ferry based on previous data however, unverified at this time.</div>
